...
/**
 * @dev To convert time unit to seconds,import TimeSetting
 */
 ...
 */
contract CustomTimelockControllerUpgradeable is
    Initializable,
    ...
    ERC1155HolderUpgradeable
{
    ...
    function initialize(
        ...
        __TimelockController_init(minDelay, proposer, executor, admin, _timer);
    }
    /**
    ...
    function __TimelockController_init(
        ...
        __TimelockController_init_unchained(minDelay, proposer, executor, admin, _timer);
    }
