export default {
  ...
  product: (...arrays: any[]) => arrays.reduce((a, b) => a.flatMap((ai: any) => b.map((bi: any) => [...ai, bi])), [[]]),
  ...
  unique: (array: any, op = (x: any) => x) =>
    array.filter((obj: any, i: any) => array.findIndex((entry: any) => op(obj) === op(entry)) === i),
  ...
  mapValues: (obj: any, fn: any, fn2 = () => true) =>
    Object.fromEntries(
      Object.entries(obj)
        .filter(fn2)
        .map(([k, v]) => [k, fn(v)]),
