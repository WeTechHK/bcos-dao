...
abstract contract GovernorTimelockControlUpgradeable is Initializable, GovernorUpgradeable {
    ...
    function __GovernorTimelockControl_init(
        CustomTimelockControllerUpgradeable timelockAddress
    ...
    function _queueOperations(
        ...
        return SafeCast.toUint48(clock() + delay);
    }
     ...
     */
    function updateTimelock(CustomTimelockControllerUpgradeable newTimelock) external virtual onlyGovernance {
        _updateTimelock(newTimelock);
    }

    function _updateTimelock(CustomTimelockControllerUpgradeable newTimelock) private {
        GovernorTimelockControlStorage storage $ = _getGovernorTimelockControlStorage();
